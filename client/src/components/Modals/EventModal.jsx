...
import { closeEventModal, addEvent, editEvent } from "@/features/eventModal/eventModalSlice";
    ...
    <div className="fixed inset-0 z-50 flex justify-center items-center" onClick={handleBackdropClick}>
      ...
      <div className="relative bg-gray-100 p-6 rounded-lg shadow-lg w-96 z-10">
        ...
        <h2 className="text-2xl font-bold mb-4">
          {eventModal.modalType === MODAL_TYPE_ADD ? "Add New" : "Edit"} Event
        </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            ...
            <input {...register("title", { required: "Event title is mandatory" })} className="w-full p-2 border rounded" />
          ...
          <div className="mb-4">
            ...
            <input type="date" {...register("date", { required: "Date is mandatory" })} className="w-full p-2 border rounded" />
            {errors.date && <p className="text-red-500 font-bold">{errors.date.message}</p>}
          </div>
          ...
          <div className="mb-4 flex space-x-4">
            <div className="w-1/2">
              ...
              <input type="time" {...register("startTime", { required: "Start time is mandatory" })} className="w-full p-2 border rounded" />
              {errors.startTime && <p className="text-red-500 font-bold">{errors.startTime.message}</p>}
            </div>
            <div className="w-1/2">
              ...
              <input
                ...
                {...register("endTime", {
                  ...
                  validate: (value) => {
                    ...
                    return startTime && value > startTime ? true : "End time must be after start time";
                  },
                })}
                className="w-full p-2 border rounded"
              />
              {errors.endTime && <p className="text-red-500 font-bold">{errors.endTime.message}</p>}
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <input {...register("attendees", { required: "Attendees is mandatory" })} className="w-full p-2 border rounded" />
            {errors.attendees && <p className="text-red-500 font-bold">{errors.attendees.message}</p>}
          </div>
